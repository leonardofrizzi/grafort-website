    ...
    >
      <div class="flex items-center justify-between">
        ...
        <div class="hidden md:block">
          <button
            class="relative bg-white text-primary font-sans font-semibold py-2.5 px-6 rounded-full transition-all duration-500 flex items-center gap-2 overflow-hidden group hover:shadow-2xl hover:shadow-white/30 hover:scale-105"
          >
            <!-- Barra laranja inferior -->
            <span class="absolute bottom-0 left-0 w-full h-1 bg-secondary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></span>

            <!-- Efeito de brilho/shine -->
            <span class="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-primary/10 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-700"></span>
      ...
      {#if isOpen}
        ...
        >
          <div use:motion class="md:hidden pt-4 pb-2 space-y-3">
            {#each menuItems as item}
              <a
                href={item.href}
            ...
            <div class="pt-2">
              <button
                class="relative w-full bg-white text-primary font-sans font-semibold py-2.5 px-6 rounded-full transition-all duration-500 flex items-center justify-center gap-2 overflow-hidden group hover:shadow-2xl hover:shadow-white/30 hover:scale-105"
              >
                <!-- Barra laranja inferior -->
                <span class="absolute bottom-0 left-0 w-full h-1 bg-secondary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></span>
